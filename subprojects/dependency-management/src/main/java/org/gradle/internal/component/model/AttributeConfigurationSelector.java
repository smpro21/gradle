...
public abstract class AttributeConfigurationSelector implements DependencyMetadata {
    ...
    public static ConfigurationMetadata selectConfigurationUsingAttributeMatching(ImmutableAttributes consumerAttributes, ComponentResolveMetadata targetComponent, AttributesSchemaInternal consumerSchema, ImmutableAttributesFactory attributesFactory, ExperimentalFeatures experimentalFeatures) {
        List<? extends ConfigurationMetadata> consumableConfigurations = targetComponent.getVariantsForGraphTraversal(attributesFactory, experimentalFeatures);
        ...
        if (matches.size() == 1) {
            ...
            throw new NoMatchingConfigurationSelectionException(consumerAttributes, attributeMatcher, targetComponent, attributesFactory, experimentalFeatures);
        }
    }
}
